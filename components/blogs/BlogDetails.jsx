    ...
    <section className="blog-page blog-single container">
      {Object.keys(blog).length > 0 ? <><div className="mw-930">
        ...
        <div className="blog-single__item-meta">
          ...
          <span className="blog-single__item-meta__date">{elm.post_date!=null?new Date(elm.post_date).toLocaleDateString():new Date(elm.created_at).toLocaleDateString()}</span>
